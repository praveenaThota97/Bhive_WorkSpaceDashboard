    ...
    return(
        <div className="appDownloadInfoContainer">
            ...
            <div className='appInfoContainer'>
                <img className='device' src='/images/mobileDevice.png'></img>
                <span>
                    <p>
                ...
                <div className='storeContainer'>
                        <a href='https://play.google.com/store/games' target='_blank'><img src='/images/playStore.png' alt='playStore'/></a>
                        <a href='https://www.apple.com/in/app-store/' target='_blank'><img src='/images/appStore.png' alt='appStore'/></a>
